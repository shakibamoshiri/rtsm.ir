...
ws.onopen = function(){
    log( "jsfun.ir web socket was opened" );
}
ws.onclose = function(){
    log( "jsfun.ir web socket was closed" );
}
...
const description = <Fragment>
    <p>Here is the log of <a target="_blank" href="http://jsfun.ir">jsfun.ir</a> which is a node js microserice for managing the blog.</p>
    ...
    <h3 class="sub-title">jsfun.ir log on the server right now:</h3>
</Fragment>; 
